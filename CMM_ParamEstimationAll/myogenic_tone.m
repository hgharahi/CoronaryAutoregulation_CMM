...
R0 = subendo.Ru(i);
Data_1 = load('Passive1.3_micro.txt'); % lz = 1.3 van Andel et al. 2003
...
PF0 = myogenic_control(subendo.Pmid(i) - subendo.Pim , subendo.Pmid(i) - subendo.Pim, ID, subendo);

x0 = mechanical_params(subendo, i, PF0*0.7, ID);

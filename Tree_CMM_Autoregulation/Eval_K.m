function [q_network, A, R, SMAX, TAU, PMID, S, SIGMA_H] = Eval_K(K, tree)
...
%                 end
        ...
        for i = 1:tree.N_gen
            ...
            if a ==3
                Smax = 0.05*tree.A.Smax;%Pressure_Dependent_Tension(tree.Pmid(i) - Pim, tree.A.Smax, tree.A.beta, tree.A.p0);
            end
            ...
            if a ==4
                Smax = tree.A.Smax;%Pressure_Dependent_Tension(tree.Pmid(i) - Pim, tree.A.Smax, tree.A.beta, tree.A.p0);
                A(i,j) = 1;
            end

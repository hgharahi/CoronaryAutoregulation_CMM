...
marker1 = '--k';
% 
[LL1, q_network1, Pmid1, tau1, A1, R1] = Remodeling5(subendo, p_in, p_out, M, af, ap, am, a, Ks0, Kp0, Km0, phi_s, phi_p, phi_m);
disp('done!')
...
[Ks0, Kp0, Km0, phi_s, phi_p, phi_m] =  stimuli_params(subepi, af, ap, am);
...
[LL2, q_network2, Pmid2, tau2, A2, R2] = Remodeling5(subepi, p_in, p_out, M, af, ap, am, a, Ks0, Kp0, Km0, phi_s, phi_p, phi_m);
disp('done!')
...
h2 = figure(2);
plot(2*subendo.Radius*1e6,1./LL1,'--','LineWidth',1.5);hold on
plot(2*subepi.Radius*1e6,1./LL2,'LineWidth',1.5);hold on

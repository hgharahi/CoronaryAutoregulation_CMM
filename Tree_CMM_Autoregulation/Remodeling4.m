function [LL, q_network, PMID, TAU, Active, R] = Remodeling4(tree, p_in, p_out, M, af, ap, am, a)
...
%                 end
        ...
        for i = 1:tree.N_gen
            S0(i) =   Km * phi_m(i)*eps - phi_s(i) * Ks *(tau(i) - tree.tau_h(i))/tree.tau_h(i) + phi_p(i) * Kp *(p_mid(i) - tree.Pmid(i))/tree.Pmid(i) + S00(i) ;%
        end
